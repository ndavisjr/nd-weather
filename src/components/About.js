...
function About() {
  return (
    <Container>
      ...
      <Contact>
        <a
          href="mailto:ndavisjr@gmail.com"
        ...
        >
          <EmailButton
            onClick={(e) => {
              window.open(
                "mailto:ndavisjr@gmail.com?subject=Email%20from%20website"
              );
              e.preventDefault();
            }}
          >
        ...
        <a
          href="https://www.instagram.com/davis_wx/"
          style={{ textDecoration: "none" }}
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a
          href=" https://www.youtube.com/channel/UCHBnNzP7l_57xvmi3ryAzNg"
          style={{ textDecoration: "none" }}
          target="_blank"
          rel="noopener noreferrer"
        >
      ...
      <Description>
        Software developer. Storm chaser. Sunset hunter. Wx Photography.
        Computer Science and Engineering Alumni of THE Ohio State University.
      </Description>
    </Container>
  );
}
